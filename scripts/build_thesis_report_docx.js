/**
 * thesis_report.md -> thesis_report.docx 변환 스크립트.
 *
 * build_thesis_docx.js(thesis.md용)와 동일한 변환 로직을 thesis_report.md
 * (제출용 정식 보고 문서 — 작업 이력·결정 로그 참조가 제거된 버전)에 적용한다.
 * 사용법: 이 저장소 바깥 아무 디렉터리에서 `npm install docx`(docx.js, v9+) 후
 *   node scripts/build_thesis_report_docx.js
 * 를 실행하면 /home/user/hongik/thesis_report.docx가 생성된다.
 */
const fs = require("fs");
...
const OUT = "/home/user/hongik/thesis_report.docx";
