...
4. "정보 불일치(Information Disorder)" 메인 논문 — **[2026-08-14] 선행연구 1차 조사 완료**(아래 신설 소절 참조). 아직 범위·목차·기존 자가 치유 논문과의 관계(완전히 별개인지, 자가 치유 메커니즘을 하위 구성요소로 재사용하는지)는 미확정 — 다음 미팅에서 구체화 필요.
